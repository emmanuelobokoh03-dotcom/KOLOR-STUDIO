...
export default function SettingsModal({ onClose, onSettingsUpdate, onRestartTutorial, initialTab }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-end md:items-center justify-center z-50 p-0 md:p-4" onClick={onClose} role="presentation">
      <div 
        className={`glass-modal md:rounded-2xl shadow-2xl w-full h-full md:h-auto md:max-h-[90vh] flex flex-col border-t md:border border-light-200 transition-all duration-300 ${
        ...
        <div className="text-white p-4 md:p-6 flex-shrink-0" style={{ background: 'linear-gradient(135deg, #1A0A3C 0%, #2D1470 100%)' }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: "rgba(255,255,255,0.55)" }}>Manage your preferences</p>
              </div>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="flex gap-1 mt-4 -mb-6 px-1 overflow-x-auto scrollbar-hide">
            ...
            <button
              ...
              data-testid="settings-tab-community"
            >
              Community
            </button>
          </div>
