    ...
    <div className="min-h-screen bg-dark-bg text-gray-300">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-10">
          ...
          <div className="bg-dark-card rounded-xl p-5 border border-dark-border">
            ...
            <p className="mt-4 text-sm text-gray-500">
              To exercise these rights, email: <a href="mailto:privacy@kolorstudio.com" className="text-violet-400 hover:underline">privacy@kolorstudio.com</a>
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gradient-to-r from-violet-900/30 to-purple-900/30 rounded-xl p-6 border border-violet-700/30">
            ...
            <div className="space-y-2">
              <p className="text-gray-400">
                Email: <a href="mailto:privacy@kolorstudio.com" className="text-violet-400 hover:underline">privacy@kolorstudio.com</a>
              </p>
              <p className="text-gray-400">
                Or: <a href="mailto:hello@kolorstudio.com" className="text-violet-400 hover:underline">hello@kolorstudio.com</a>
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-between items-center pt-8 border-t border-dark-border">
          ...
          <Link to="/terms" className="text-violet-400 hover:text-violet-300 transition">
            Terms of Service →
          </Link>
        </div>
      </main>
