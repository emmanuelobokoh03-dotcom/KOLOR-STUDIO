    ...
    <div className="min-h-screen bg-light-50 text-text-secondary">
      ...
      <header className="bg-white border-b border-light-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link to="/privacy" className="text-sm text-text-secondary hover:text-white transition">
            Privacy Policy
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-br from-brand-primary-dark/30 to-brand-primary-dark/30 rounded-xl p-5 border border-purple-200">
              <div className="flex items-center gap-2 mb-3">
        ...
        <section className="mb-10">
          ...
          <div className="bg-red-900/10 rounded-xl p-5 border border-red-200">
            <p className="text-text-secondary mb-4">You may not:</p>
            <ul className="grid md:grid-cols-2 gap-2 text-text-secondary text-sm">
              <li className="flex items-start gap-2">
                <span className="text-red-400 mt-0.5">✗</span>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
            <Scales className="w-5 h-5 text-purple-600" />
            11. Limitation of Liability
          </h2>

          <div className="space-y-4">
            <div className="bg-yellow-900/10 rounded-xl p-5 border border-yellow-200">
        ...
        <div className="flex justify-between items-center pt-8 border-t border-light-200">
          ...
          <Link to="/privacy" className="text-purple-600 hover:text-purple-600 transition">
            Privacy Policy →
          </Link>
        </div>
      </main>
